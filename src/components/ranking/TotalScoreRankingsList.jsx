// src/components/ranking/TotalScoreRankingsList.jsx

import React from 'react';
import { formatPlayerName } from '../../utils/playerUtils';

/**
 * En Çok Sayı Çekenler
 * TASARIM: Kompakt & Yoğun (RankingList ile aynı)
 */
function TotalScoreRankingsList({ rankings, players, onUsernameClick }) {
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-3 py-1.5 bg-white">
                            ...
                            <div className="flex items-center gap-2 ml-2">
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-tight">SKOR</span>
                                <span className="bg-green-600 text-white text-sm font-bold px-2 py-0.5 rounded-md shadow-sm min-w-[50px] text-center">
                                    {r.totalScore}
                                </span>
                            </div>
                        </div>
...
export default TotalScoreRankingsList;